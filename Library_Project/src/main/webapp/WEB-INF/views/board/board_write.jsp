    ...
    <div class="content three_quarter"> 
	  ...
	  <form name="ff" method="post" action="board_insert.do">
	      ...
	      <div class="scrollable">
	        ...
	        <div>
				<img src="${pageContext.request.contextPath}/resources/images/img/btn_back.gif" onclick="location.href='board.do'"
						 style="cursor:pointer" align="right">
	        	<img src="${pageContext.request.contextPath}/resources/images/img/btn_reg.gif" onclick="send_check(this.form);"
						 style="cursor:pointer" align="right">
	        </div>
	      </div>
      </form>
