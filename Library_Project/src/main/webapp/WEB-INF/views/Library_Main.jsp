...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay" style="background-image:url('${pageContext.request.contextPath}/resources/images/demo/backgrounds/test1.png');">
  ...
  <main class="hoc container clear"> 
    ...
    <section>
      ...
      <ul class="nospace group overview">
        <li class="one_third">
          <figure><a href="#"><img src="${pageContext.request.contextPath}/resources/images/demo/348x261.png" alt=""></a>
            <figcaption>
...
<div class="wrapper row2">
  <figure class="hoc container clear clients"> 
    <!-- ################################################################################################ -->
    <ul class="nospace group">
      <li class="one_quarter first"><a href="#"><img src="${pageContext.request.contextPath}/resources/images/demo/249x100.png" alt=""></a></li>
      <li class="one_quarter"><a href="#"><img src="${pageContext.request.contextPath}/resources/images/demo/249x100.png" alt=""></a></li>
      <li class="one_quarter"><a href="#"><img src="${pageContext.request.contextPath}/resources/images/demo/249x100.png" alt=""></a></li>
      <li class="one_quarter"><a href="#"><img src="${pageContext.request.contextPath}/resources/images/demo/249x100.png" alt=""></a></li>
    </ul>
    <!-- ################################################################################################ -->
